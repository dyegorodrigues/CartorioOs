...
| RG-RESP-T777 | Estado responde objetivamente por danos causados por tabeliães/registradores no exercício das funções, com dever de regresso em dolo/culpa | STF Tema 777, RE 842846 | BA discursiva pergunta responsabilidade estatal no contexto de interino; triangulação específica pendente | tese vinculante / responsabilidade | H | VH | H | VH | CORE/P2 |
...
| RG-LOSS-035 | Perda da delegação depende de sentença judicial transitada em julgado OU decisão em processo administrativo pelo juízo competente, assegurada ampla defesa | L8935 art. 35 | ENAC 2025.2 Q43, gab. B | falsa exclusividade + `ou` | VH | H | VH | H/VH | C0 DIRECT |
...
| RG-INT-ADI1183 | Interinidade decorrente de vacância não pode resultar em substituição ininterrupta por preposto não concursado por mais de 6 meses, conforme decisão/modulação STF | STF ADI 1183 | BA tangencia controle/seleção; incidência específica ainda a contar | jurisprudência avançada + limite temporal | M/H | H | M/H | H | P2 CANDIDATE |
...
- contraste com responsabilidade objetiva do Estado (Tema 777), sem misturar sujeitos;
- casos objetivos e depois output quando fase/corpus justificar.

### Cluster arts. 29–30
Não usar uma tabela gigante para decorar plana. Organizar:
1. direitos (poucos);
2. deveres por função semântica;
3. palavras fatais;
4. itens mais recorrentes;
5. Q→A + role-swap questions.

### Regime disciplinar
Ensinar como grafo:
`conduta/gravidade → infração → pena → prazo → procedimento/autoridade → cautelar/interventor`.
Evitar lista desconectada de arts. 31–36.

## Próxima expansão
1. C0: CF 236 + CNN/CNJ que pertencem a Regime Geral.
2. C1/C2: heatmap arts. 20–36 por banca e Estado.
3. Triangulação FGV estadual RN/ES + Cebraspe RO/RR.
4. Vincular cada questão ao `BUILD/VALIDATION/HELD-OUT/CHALLENGE` antes de gerar material.
5. Depois emitir scores numéricos, não antes.